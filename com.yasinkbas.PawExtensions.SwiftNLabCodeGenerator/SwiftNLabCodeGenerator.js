...
(function() {
  var SwiftNLabCodeGenerator, addslashes, slugify;
  ...
  SwiftNLabCodeGenerator = function() {
  ...
  SwiftNLabCodeGenerator.identifier = "com.yasinkbas.PawExtensions.SwiftNLabCodeGenerator";

  SwiftNLabCodeGenerator.title = "Swift (NLab)";

  SwiftNLabCodeGenerator.fileExtension = "swift";

  SwiftNLabCodeGenerator.languageHighlighter = "swift";

  registerCodeGenerator(SwiftNLabCodeGenerator);
